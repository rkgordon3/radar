class Ability
  ...
  def initialize(staff)
    ...
    alias_action :new, :new_with_participants, :update_duration, :update_common_duration, :update_reason,
      ...
      :update_annotation, :remove_participant, :create_participant_and_add_to_report, :add_participant,
      :to => :create # I tried to include all actions needed throughout the report creation process -Lyric
