class Report < ActiveRecord::Base
  ...
  def can_submit_from_mobile?
    ReportType.find_by_name(self.type).submit_on_mobile?
  end
  ...
  def can_edit_from_mobile?
    ReportType.find_by_name(self.type).edit_on_mobile?
  end
  ...
  def supports_selectable_contact_reasons?
    ReportType.find_by_name(self.type).selectable_contact_reasons?
  end
